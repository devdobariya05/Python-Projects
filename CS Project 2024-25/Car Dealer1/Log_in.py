...
class Window_1:
    def __init__(self, master):
        ...
        self.Frame = Frame(self.master, bg = 'maroon')
        self.Frame.pack()
        ...
        self.Lbl_Title = Label(self.Frame, text = 'Login Form', font = ('algerian',55,'underline'), bg = 'maroon', fg = 'red')
        self.Lbl_Title.grid(row = 0, column = 0, columnspan =3, pady = 40)
        
        self.Login_Frame_1 = LabelFrame(self.Frame, width = 1350, height = 150, relief = 'ridge', bg = 'sky blue', bd = 13, text='Login', fg = 'darkblue',
                                        font = ('lucida calligraphy',25,'bold'))
        self.Login_Frame_1.grid(row = 1, column =0)
        self.Login_Frame_2 = LabelFrame(self.Frame, width = 1000, height = 150, relief = 'ridge',bg = 'Orange', bd = 15, text='Events', fg = 'darkblue',
                                        font = ('lucida calligraphy',25,'bold'))
        self.Login_Frame_2.grid(row = 2, column = 0)


        #===================================================LABEL and ENTRIES=======================================================================
        self.Label_Username = Label(self.Login_Frame_1, text = 'Username', font = ('lucida handwriting',20,'bold'), bg = 'sky blue', fg = 'black', bd = 20)
        ...
        self.Label_Password = Label(self.Login_Frame_1, text = 'Password', font = ('lucida handwriting',20,'bold'), bg = 'sky blue', fg = 'black', bd = 20)
